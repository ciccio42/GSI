...
void Match::copyHtoD(unsigned *&d_ptr, unsigned *h_ptr, unsigned bytes)
{
    unsigned *p = NULL;
    cudaMalloc(&p, bytes);
...
int Match::get_minimum_idx(float *score, int qsize)
{
    float *min_ptr = NULL;
...
bool Match::score_node(float *_score, int *_qnum)
{
    bool success = true;
...
bool Match::filter(float *_score, int *_qnum)
{
...
void Match::update_score(float *_score, int qsize, int _idx)
{
...
void Match::acquire_linking(int *&link_pos, int *&link_edge, int &link_num, int idx)
{
...
bool Match::join(unsigned *d_summary, int *link_pos, int *link_edge, int link_num, unsigned *&d_result, unsigned *d_candidate, unsigned num, unsigned &result_row_num, unsigned &result_col_num)
{
...
void Match::match(IO &io, unsigned *&final_result, unsigned &result_row_num, unsigned &result_col_num, int *&id_map)
{
